...
/*package*/ class Circle_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.x$MxQU;
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.y$My5V;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private EditorCell createProperty_2() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.radius$MykW;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private static final class PROPS {
    /*package*/ static final SProperty x$MxQU = MetaAdapterFactory.getProperty(0x74580cf92664bb5L, 0x955558b1421aadc4L, 0x56f824b75a1063dcL, 0x56f824b75a1063dfL, "x");
    ...
    /*package*/ static final SProperty radius$MykW = MetaAdapterFactory.getProperty(0x74580cf92664bb5L, 0x955558b1421aadc4L, 0x56f824b75a1063dcL, 0x56f824b75a1063e1L, "radius");
  }
